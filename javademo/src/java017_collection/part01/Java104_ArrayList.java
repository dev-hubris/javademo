...
//ArrayList 순차적으로 사용 -> 수정이 별로 없이 순차적 사용
//LinkedList 노드를 이용해서 사용 -> 중간에 변경하는 게 많다, 수시로 변경이 필요할 때? 
// 근데 영한님은 앞라인에서 변경이 많이 일어날 경우만 linkedList 고려 나머지 90% arrayList
public class Java104_ArrayList {
